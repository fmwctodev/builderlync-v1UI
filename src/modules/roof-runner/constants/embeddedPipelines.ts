...
export const DEFAULT_PIPELINE_STAGES = [
  ...
  { name: 'Follow-Up 1', order_position: 1, color: '#DC2626', include_in_funnel: true, include_in_distribution: true },
  ...
  { name: 'Long Term Follow Up', order_position: 4, color: '#DC2626', include_in_funnel: true, include_in_distribution: true },
  ...
  { name: 'Job Qualified', order_position: 7, color: '#DC2626', include_in_funnel: true, include_in_distribution: true },
