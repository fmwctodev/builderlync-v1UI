...
export default function WorkOrders() {
  ...
  const statusOptions = ['draft', 'sent', 'in progress', 'completed'];
        ...
        <table className="w-full">
          <thead className="bg-gray-50 dark:bg-gray-700">
            <tr>
              ...
              <th className="px-4 py-3 text-left text-xs font-medium text-gray-500 dark:text-gray-300 uppercase tracking-wider">Job Address</th>
              ...
              <th className="px-4 py-3 text-left text-xs font-medium text-gray-500 dark:text-gray-300 uppercase tracking-wider">Crew Contact</th>
...
function WorkOrderRow() {
  ...
  return (
    <tr>
      ...
      <td className="px-4 py-4 whitespace-nowrap text-sm text-gray-900 dark:text-white">#WO-001</td>
      <td className="px-4 py-4 whitespace-nowrap text-sm text-gray-900 dark:text-white">123 Main St, City, ST</td>
      <td className="px-4 py-4 whitespace-nowrap text-sm text-gray-900 dark:text-white">John Doe</td>
