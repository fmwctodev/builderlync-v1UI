...
import { MapPin, Camera, Download, Eye, Search, Loader2, Calendar } from 'lucide-react';
...
const EagleViewMeasurement: React.FC<EagleViewMeasurementProps> = ({ onReportSelect }) => {
  const [activeTab, setActiveTab] = useState<'reports' | 'imagery'>('reports');
      ...
      <div className="border-b border-gray-200 dark:border-gray-700">
        <nav className="flex space-x-8">
          ...
          <button
            ...
            className={`py-2 px-1 border-b-2 font-medium text-sm ${activeTab === 'imagery'
              ? 'border-primary-500 text-primary-600'
              : 'border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300'
              }`}
          >
