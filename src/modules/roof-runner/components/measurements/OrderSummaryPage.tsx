    ...
    <div className="space-y-6">
      ...
      <div className="bg-primary-600 dark:bg-blue-700 rounded-lg p-6 text-white">
        <div className="flex items-center gap-4 mb-4">
          <button
            onClick={onBack}
            className="inline-flex items-center gap-2 px-3 py-2 text-sm font-medium text-blue-100 hover:text-white bg-blue-700 hover:bg-blue-800 rounded-md"
          >
              ...
              <div className="flex gap-3">
                ...
                <button
                  ...
                  className={`flex-1 px-4 py-2 text-sm font-medium text-white rounded-md disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2 ${
                    Object.keys(validationErrors).length > 0 ? 'bg-red-600 hover:bg-red-700' : 'bg-primary-600 hover:bg-primary-700'
                  }`}
                >
                  {isPlacingOrder ? (
                    <>
