      ...
      <div className="space-y-3">
        ...
        <div className="flex gap-3">
          ...
          <button 
            onClick={onNext}
            disabled={disabled}
            className="flex-1 px-4 py-2 text-sm font-medium text-white bg-primary-600 rounded-md hover:bg-primary-700 disabled:opacity-50 disabled:cursor-not-allowed disabled:hover:bg-primary-600"
            title={disabled ? "Please complete all required fields" : ""}
          >
            Continue to Payment
          </button>
        </div>
