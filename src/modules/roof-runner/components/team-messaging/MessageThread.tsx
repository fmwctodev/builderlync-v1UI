                      ...
                      >
                        ...
                        <p
                          className={`text-xs mt-1.5 ${
                            message.is_own_message ? 'text-white' : 'text-gray-500 dark:text-gray-400'
                          }`}
                        >
      ...
      <div className="p-4 border-t border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800">
        <div className="flex items-end space-x-2">
          <textarea
            ...
            rows={3}
            className="flex-1 px-4 py-3 border border-gray-300 dark:border-gray-600 rounded-lg resize-none focus:outline-none focus:ring-2 focus:ring-red-600 focus:border-transparent dark:bg-gray-700 dark:text-white placeholder-gray-400"
          />
