...
const IntegrationsTab: React.FC = () => {
  const integrations = [
    ...
    { name: 'Better Business Bureau', icon: 'BBB', color: 'bg-primary-50 dark:bg-primary-900/20 text-blue-700 dark:text-primary-400' },
    ...
    { name: 'Indeed', icon: 'i', color: 'bg-blue-700 text-white' },
    { name: 'Thumbtack', icon: '📌', color: 'bg-green-50 dark:bg-green-900/20' },
    { name: 'Trustradius', icon: 'TR', color: 'bg-teal-50 dark:bg-teal-900/20 text-teal-700 dark:text-teal-400' },
