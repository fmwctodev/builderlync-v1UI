      ...
      <div className="bg-white dark:bg-slate-900 border border-gray-200 dark:border-slate-700 rounded-2xl shadow-2xl w-full max-w-md">
            ...
            <div className="space-y-2">
              {CADENCE_OPTIONS.map((option) => (
                <button
                  ...
                  className={`w-full flex items-center justify-between px-4 py-2.5 rounded-lg border text-sm font-medium transition-colors ${
                    !useCustom && selectedDays === option.value
                      ? 'bg-primary-500/10 border-primary-500/30 text-primary-600 dark:text-primary-300 ring-1 ring-primary-500/10'
                ...
                >
                  ...
                  {option.value === 30 && (
                    <span className="text-xs px-2 py-0.5 rounded-full bg-primary-500/10 text-primary-600 dark:text-primary-400 border border-primary-500/20">
                      Recommended
                    </span>
                  )}
                </button>
              ...
              {useCustom && (
                <div className="flex items-center gap-2 px-4">
                  ...
                  <input
                    ...
                    className="w-20 px-2 py-1 bg-gray-50 dark:bg-slate-700 border border-gray-300 dark:border-slate-600 rounded text-gray-900 dark:text-white text-sm text-center focus:outline-none focus:ring-1 focus:ring-primary-500"
                  />
        ...
        <div className="p-6 border-t border-gray-200 dark:border-slate-700 flex justify-end gap-3">
          ...
          <button
            ...
            className="px-5 py-2 bg-primary-600 hover:bg-primary-500 disabled:opacity-50 disabled:cursor-not-allowed text-white text-sm font-medium rounded-lg transition-colors"
          >
