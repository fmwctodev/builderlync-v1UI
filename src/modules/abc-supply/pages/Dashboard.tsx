      ...
      <section className="bg-gray-800 rounded-lg p-6 md:p-8">
        ...
        <div className="mt-6 grid grid-cols-1 md:grid-cols-3 gap-4">
          ...
          >
            ...
            <div className="ml-4">
              <h3 className="text-lg font-medium text-white group-hover:text-red-400 transition">Browse Products</h3>
          ...
          <Link
            ...
            className="bg-gray-700 rounded-lg p-4 flex items-center hover:bg-gray-600 transition group"
          >
            <div className="h-10 w-10 flex-shrink-0 bg-red-600/20 rounded-lg flex items-center justify-center">
          ...
          >
            ...
            <div className="ml-4">
              <h3 className="text-lg font-medium text-white group-hover:text-red-400 transition">View Orders</h3>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <section className="lg:col-span-2 bg-gray-800 rounded-lg">
          <div className="px-6 py-5 border-b border-gray-700 flex justify-between items-center">
            ...
            <Link to="/abc-supply/orders" className="text-red-400 flex items-center text-sm font-medium hover:text-primary-300 transition">
        ...
        <div className="space-y-6">
          ...
          <section className="bg-gray-800 rounded-lg">
            <div className="px-6 py-5 border-b border-gray-700 flex justify-between items-center">
              ...
              <Link to="/abc-supply/products" className="text-red-400 flex items-center text-sm font-medium hover:text-primary-300 transition">
                View all <ChevronRight className="h-4 w-4 ml-1" />
              </Link>
            </div>
          ...
          <section className="bg-gray-800 rounded-lg">
            <div className="px-6 py-5 border-b border-gray-700 flex justify-between items-center">
              ...
              <Link to="/abc-supply/branches" className="text-red-400 flex items-center text-sm font-medium hover:text-primary-300 transition">
                View all <ChevronRight className="h-4 w-4 ml-1" />
              </Link>
            </div>
