...
export function Dashboard() {
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      <div className="mb-8">
        <h1 className="text-3xl font-bold text-gray-900 dark:text-white">BuilderLynk Dashboard</h1>
        ...
        {modules.map((module) => {
          ...
          return (
            <Link
              key={module.name}
              to={module.href}
              className="group relative card p-6 hover:shadow-md transition-all duration-200"
            >
              <div className="flex items-center">
                ...
                <ArrowRight className="w-5 h-5 text-gray-400 dark:text-gray-500 group-hover:text-primary-600 dark:group-hover:text-primary-400" />
              </div>
            </Link>
          );
        })}
