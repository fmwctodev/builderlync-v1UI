/*
  # Fix Sync Function Column Names

  ## Overview
  Updates the sync function to use correct column names from organizations table:
  - selected_plan instead of subscription_tier
  - No is_active column (organizations without this column are considered active)

  ## Changes
  - Updates sync_organizations_to_enterprise_accounts() function
  - Uses correct column names from organizations table
*/
...
BEGIN
  ...
  LOOP
    BEGIN
      ...
      plan_name := COALESCE(org_record.selected_plan, 'Starter');
